...
from constraints import node_visit_constraints, load_balance_constraints, time_constraints, battery_constraints, variable_constraints
from state import EVRPState
...
def clustering(instance, lambda_=0.5):
    ...
    while len(E) + len(C) < len(N):
        ...
        i_C = max(p_C, key=p_C.get)  # 修复错误的括号

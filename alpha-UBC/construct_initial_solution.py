...
from constraints import (calculate_insertion_cost, is_feasible_conventional,
                         is_feasible_electric, find_nearest_charging_station,
                         verify_time_windows, repair_solution)
...
def insertion_heuristic_conventional(instance, cluster):
    ...
    while unserved_customers:
        ...
        while unserved_customers:
            ...
            if best_customer is None or not is_feasible_conventional(instance, route, best_position, best_customer,
                                                                     vehicle_capacity):
                break

...
def clustering(instance):
    ...
    while unassigned_customers:
        ...
        if remaining_customers:
            ...
            pQ[remaining_customers] = 11 - 1 + (instance.customer_demand[remaining_customers] - q_min) / (
                        q_max - q_min) * 9
            p_C[remaining_customers] = lambda_param * pDist_C[remaining_customers] + (1 - lambda_param) * pQ[
                remaining_customers]
